...
class DetailViewModel : ViewModel() {
    fun addToFavorite(context: Context, intent: Intent, applicationContext: Context) {
        ...
        Toast.makeText(context, "${movie.id} - added to favorite", Toast.LENGTH_SHORT).show()
    }
    ...
    fun removeFavorite(context: Context, intent: Intent, applicationContext: Context) {
        ...
        Toast.makeText(context, "${movie.id} - removed from favorite", Toast.LENGTH_SHORT).show()
    }
}